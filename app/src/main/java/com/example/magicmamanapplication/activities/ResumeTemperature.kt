...
import com.example.magicmamanapplication.adapters.MyTemperatureAdapter
...
import kotlinx.android.synthetic.main.activity_resume_temperature.*

class ResumeTemperature : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.myCustomTemperature(5,"id", "desc")

        viewModel.myCustomTemperature.observe(this, Observer { response ->
    ...
    private fun setupRecyclerview() {
        recycleviewTemperature.adapter = myAdapter
        recycleviewTemperature.layoutManager = LinearLayoutManager(this)
