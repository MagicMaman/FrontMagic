...
import kotlinx.android.synthetic.main.activity_repas_solide.edt_notes_solid
import kotlinx.android.synthetic.main.activity_sommeill.*
...
class Sommeill : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNextSommeill.setOnClickListener {
            ...
            if (!etTimeSommeill.text.isEmpty() && !etTimeReveil.text.isEmpty() && !edt_notes_sommeill.text.isEmpty()) {
            ...
            else
            {
                ...
                val layout1 : View = layoutInflater.inflate(R.layout.sommeil_toast, ll_wrapper)
